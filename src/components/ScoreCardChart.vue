...
function renderChart() {
  ...
  svg
    ...
    .attr('d', d => {
      ...
      if (d.width > 0) {
        return `M${xStart},${yPos} L${xEnd},${yPos} L${xEnd - arrowHeadSize
          },${yPos - arrowHeadSize} M${xEnd},${yPos} L${xEnd - arrowHeadSize},${yPos + arrowHeadSize
          }`;
      } else if (d.width < 0) {
        return `M${xEnd},${yPos} L${xStart},${yPos} L${xStart + arrowHeadSize
          },${yPos - arrowHeadSize} M${xStart},${yPos} L${xStart + arrowHeadSize
          },${yPos + arrowHeadSize}`;
      }
    })
    .style('fill', 'none')
