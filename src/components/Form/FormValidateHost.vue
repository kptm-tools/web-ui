  ...
  <q-form @submit="validateHostHandler">
    <div class="row">
      ...
      <div class="col-9 flex justify-between">
        ...
        <q-btn square color="primary" icon="add" :disable="!isValidated || (isValidated && !isDomain)"
    ...
    <div class="row q-mb-md">
      <template v-for="validatedDomain in validatedDomains" :key="validatedDomain.value">
        <q-chip clickable color="grey" text-color="white" icon-right="close" dense :label="validatedDomain.hostname"
          @click="removeHostValidated(validatedDomain.value)"></q-chip>
      </template>
    </div>
    <div class="row">
      <div class="col-3 flex">
    ...
    <div class="row q-mb-md">
      <template v-for="validatedIp in validatedIps" :key="validatedIp.value">
        <q-chip clickable color="grey" text-color="white" icon-right="close" :label="validatedIp.hostname" dense
          @click="removeHostValidated(validatedIp.value)"></q-chip>
      </template>
    </div>
    ...
    <div class="row q-mb-md">
      <q-input v-model="hostname" outlined dense>
        <template #before>
          <label class="input-label">Hostname</label></template></q-input>
    </div>
