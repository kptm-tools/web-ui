...
export async function getScanInsightsFromService(scan_id: string = ''): Promise<ScanInsight> {
  return (await ScanService.getScanInsights(scan_id)).data;
}

export async function postScanCancelService(scan_id: string = ''): Promise<string> {
