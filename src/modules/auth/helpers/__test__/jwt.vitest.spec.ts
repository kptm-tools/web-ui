...
import { decodeJwt, base64UrlDecode } from 'auth/helpers/jwt';

describe('auth/helpers:jwt', () => {
  describe('base64UrlDecode', () => {
    ...
    it('should correctly decode a Base64Url string with URL-safe characters', () => {
      const encodedWithSafeChars = 'Zm9vYmFyX2lz'; // "foobar_is"
...
// Helper function for the complex payload test
