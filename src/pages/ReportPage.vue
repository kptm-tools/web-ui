<template>
  ...
  <div class="q-pa-md">
    <q-btn label="Scoredcard Trends" color="primary" class="q-mb-md" @click="openScoredcardTrends"></q-btn>
...
async function handleTableAction(action: ReportTableEventAction): Promise<void> {
