  ...
  <q-layout view="lHh lpR lFf" class="bg-grey-2">
            ...
            <template #append>
              <q-icon name="event" class="cursor-pointer">
                <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                  <q-date v-model="creationDate" @update:model-value="handleDate">
    ...
    <q-drawer show-if-above side="left" class="flex column" :width="showSecondDrawer ? 500 : 300">
      <div style="width: 300px; display: flex; flex-direction: column; height: 100%">
        ...
        <q-list style="height: calc(100% - 90px)" class="flex column justify-between">
          <div style="margin-top: 40%">
            <q-item v-ripple clickable to="/" class="nav-item" :active="route.name === 'Home'">
            ...
            <q-item v-ripple clickable to="scans" class="nav-item" :active="route.name === 'Scans'">
              <q-item-section avatar class="q-px-none items-center">
                <q-icon name="search" />
              </q-item-section>
              <q-item-section>
      ...
      <div v-if="showSecondDrawer" style="width: 200px; height: 100%; overflow: hidden">
    ...
    <q-page-container style="overflow: hidden">
      <div class="row">
        <div class="col">
          <div class="bg-white q-ma-sm" style="height: calc(100vh - 85px); border-radius: 1em">
            <router-view />
          </div>
        </div>
      </div>
